...
COPROCESSOR_REG(drbar, "p15", 0, "c6", "c1", 0)
COPROCESSOR_REG(drsr, "p15", 0, "c6", "c1", 2)
COPROCESSOR_REG(dracr, "p15", 0, "c6", "c1", 4)
COPROCESSOR_REG(rgnr, "p15", 0, "c6", "c2", 0)
