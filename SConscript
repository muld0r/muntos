...
pthread_rt = pthread_env.StaticLibrary(target='pthread_rt', source=['src/rt.c', 'src/delay.c', 'src/queue.c', 'src/sem.c'])
...
pthread_env.Program([pthread_queue, pthread_rt, 'pthread/rt_port.c'])
